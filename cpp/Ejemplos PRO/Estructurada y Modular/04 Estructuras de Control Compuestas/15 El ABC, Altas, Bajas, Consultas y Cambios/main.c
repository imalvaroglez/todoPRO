...
typedef enum {ALTA=1,BAJA,CONSULTA,CAMBIO,BUSQUEDA,SALIR} opcionesMenu;
...
void darDeBajaProfesor(){
    ...
    printf("Indica el numero de registro a eliminar (0 a %d): ",MAX_PROFESORES-1);
    scanf("%d",&i);
    if (elRegistroProfesorTieneDatos(i)){
        mostrarProfesor(i);
        printf("Estas seguro de eliminar el registro (s/n)?");
        getchar();
        scanf("%c",&opcion);
...
void consultarProfesor(){
    ...
    printf("Indica el numero de registro a consultar (0 a %d): ",MAX_PROFESORES-1);
    scanf("%d",&i);
    if (elRegistroProfesorTieneDatos(i)){
        mostrarProfesor(i);
    }
...
void cambiarDatosDeProfesor(){
    ...
    printf("Indica el numero de registro a modificar (0 a %d): ",MAX_PROFESORES-1);
    scanf("%d",&i);
    if (elRegistroProfesorTieneDatos(i)){
        mostrarProfesor(i);
        modificarRegistroProfesor(i);
